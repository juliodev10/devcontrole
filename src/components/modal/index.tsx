...
export function ModalTicket() {
  const { handleModalVisible, ticket } = useContext(ModalContent);
  ...
  return (
    <div className="absolute bg-gray-900/80 w-full min-h-screen" onClick={handleModalClick}>
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        {/* Início da caixa branca do Modal */}
        <div ref={modalRef} className="bg-white shadow-lg w-4/5 md:w-1/2 max-w-2xl p-3 rounded">
          ...
          {/* Linha divisória e detalhes do cliente agora estão DENTRO do modal */}
          <div className="w-full border-b-[1.5px] my-4"></div>

          <h1 className="font-bold text-lg md:text-xl mb-2">Detalhes do cliente</h1>
